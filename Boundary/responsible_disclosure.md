...
> (ECC) Zashi wallet. The following responsible disclosure policy text is
> reproduced from ECC’s Zcash security disclosures; references to “Zashi
> wallet(s)” describe the upstream project and are preserved for attribution.
